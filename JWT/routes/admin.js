module.exports = (dbConnection) => {
  ...
  router.post('/login', function(req, res, next){
    dbConnection.query(`SELECT * FROM admin_accounts WHERE username = ${req.body.username}`, (err, user) => {
      if (err) next(err);
      if (!user) {
  ...
  router.post('/register', function(req, res, next){
    ...
    dbConnection.query(`INSERT INTO admin_accounts VALUE (${req.body.username}, ${hash}, ${salt})`, (err, user) => {
